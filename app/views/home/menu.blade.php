                        ...
                        <ul class="restaurant_menu__list">
                            ...
                            <li class="restaurant_menu__row">
                                <div class="restaurant_menu__meal">
											<span>
												<!--PRODUCT-->
												<input class="inputfor" type="checkbox" id="product_{{$prods->id}}" onclick="calc()"/>
										...
										<span class="restaurant_menu__price">
											<strong>რაოდენობა:</strong> <input type="number" name="raodenoba" id="raodenoba" min="0" value="0" style="width: 40px;" />
										</span>
...
<script>
    ...
    <script>
        function calc() {
            ...
            if (document.getElementById("product_{{$single->id}}").checked) {
                fullPrice += parseFloat(document.getElementById("product_price_{{$single->id}}"));
